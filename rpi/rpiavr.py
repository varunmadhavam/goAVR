...
class rpiavr:
    ...
    def init(self,pagesize_flash,pagesize_eeprom,flash_size,eeprom_size,twd_fuse,twd_flash,twd_eeprom,twd_erase):
        if(not pagesize_flash or not pagesize_eeprom or not flash_size or not eeprom_size or not twd_fuse or not twd_flash or not twd_eeprom or not twd_erase):
            self.intialized=0
            return 1
        else:
